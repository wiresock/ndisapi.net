...
namespace NdisApiDotNet.Native
{
    ...
    public struct TCPUDPFilter // TCPUDP_FILTER
    {
        ...
        public TCPUDPFilter(FilterFlags validFields, PortRange source, PortRange destination, byte tcpFlags = 0)
        {
        ...
        public TCPUDPFilter(FilterFlags validFields, PortRange ports) : this(validFields, ports, ports)
        {
        }
    }
}