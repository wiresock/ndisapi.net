...
namespace NdisApiDotNet.Native
{
    ...
    public unsafe struct EthMRequestUnsafe : IDisposable // ETH_M_REQUEST_U
    {
        ...
        public EthPacket[] GetPackets(uint packets = 0)
        {
            ...
            long sizeToCopy = Consts.NdisRdEthPacketSize * packetSize;
            fixed (EthMRequestUnsafe* a = &this)
{
                Imports.MemoryCopy((void*)((IntPtr)a + Consts.EthMRequestUEthPacketOffset), (void*)pinnedNdisrdEthPackets.AddrOfPinnedObject(), sizeToCopy);
            }
        ...
        public void SetPackets(EthPacket[] packets)
        {
            ...
            int sizeToCopy = Consts.NdisRdEthPacketSize * packets.Length;
            fixed (EthMRequestUnsafe* a = &this)
            {
                Imports.MemoryCopy((void*)pinnedNdisrdEthPackets.AddrOfPinnedObject(), (void*)((IntPtr)a + Consts.EthMRequestUEthPacketOffset), sizeToCopy);
            }
