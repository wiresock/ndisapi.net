...
namespace NdisApiDotNet.Native
{
    ...
    public unsafe struct StaticFilterTableUnsafe // STATIC_FILTER_TABLE_U
    {
        ...
        public StaticFilterUnsafe[] GetStaticFilters(uint filters = 0)
        {
            ...
            long sizeToCopy = NdisApi.StaticFilterUSize * filterSize;
            fixed (StaticFilterTableUnsafe* a = &this)
            {
                NdisApi.MemoryCopy((void*)((IntPtr)a + NdisApi.StaticFilterTableUStaticFiltersOffset), (void*)pinnedStaticFilters.AddrOfPinnedObject(), sizeToCopy);
            }
        ...
        public void SetStaticFilters(StaticFilterUnsafe[] filters)
        {
            ...
            int sizeToCopy = NdisApi.StaticFilterUSize * filters.Length;
            fixed (StaticFilterTableUnsafe* a = &this)
            {
                NdisApi.MemoryCopy((void*)pinnedStaticFilters.AddrOfPinnedObject(), (void*)((IntPtr)a + NdisApi.StaticFilterTableUStaticFiltersOffset), sizeToCopy);
            }
