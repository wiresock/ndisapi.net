...
namespace NdisApiDotNet.Native
{
    ...
    public unsafe struct PacketOID // PACKET_OID_DATA
    {
        ...
        public byte[] GetData(uint length = 0)
        {
            ...
            long sizeToCopy = Consts.NdisRdEthPacketSize * size;
            fixed (PacketOID* a = &this)
            {
                Imports.MemoryCopy((void*)((IntPtr)a + Consts.PacketOidDataDataOffset), (void*)pinnedData.AddrOfPinnedObject(), sizeToCopy);
            }
        ...
        public void SetData(byte[] data)
        {
            ...
            fixed (PacketOID* a = &this)
            {
                Imports.MemoryCopy((void*)pinnedData.AddrOfPinnedObject(), (void*)((IntPtr)a + Consts.PacketOidDataDataOffset), sizeToCopy);
            }
