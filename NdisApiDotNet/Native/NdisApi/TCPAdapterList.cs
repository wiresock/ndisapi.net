...
namespace NdisApiDotNet.Native
{
    ...
    public struct TCPAdapterList // TCP_AdapterList
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = Consts.ADAPTER_LIST_SIZE * Consts.ADAPTER_NAME_SIZE)]
        internal byte[] m_szAdapterNameList;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = Consts.ADAPTER_LIST_SIZE)]
        internal IntPtr[] m_nAdapterHandle;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = Consts.ADAPTER_LIST_SIZE)]
        internal NdisMedium[] m_nAdapterMediumList;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = Consts.ADAPTER_LIST_SIZE * Consts.ETHER_ADDR_LENGTH)]
